...
window.onload = function () {
  initMap();
  generateMaze();
  loadVoices(); // Précharger les voix pour réduire la latence
};

// Fonction pour précharger les voix
function loadVoices() {
  if ('speechSynthesis' in window) {
    speechSynthesis.getVoices(); // Force le chargement des voix
  }
}
...
function startTutorial() {
  ...
  const tutorialSteps = [
    ...
    },
    {
      ...
      action: () => document.querySelector('.content-block').scrollIntoView({ behavior: 'smooth' })
    },
    {
